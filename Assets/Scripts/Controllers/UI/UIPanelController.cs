...
namespace Controllers.UI
{
    public class UIPanelController : MonoBehaviour
    {
        ...
        [Button("OnOpenPanel")]
        private void OnOpenPanel(UIPanelTypes panelTypes, int layerValue)
        {
            OnClosePanel(layerValue);
            Instantiate(Resources.Load<GameObject>($"Screens/{panelTypes.ToString()}Panel"), layers[layerValue]);
        }
